...
STYLES = {
    'keyword': format('#2fd6ff'),
    'operator': format('#f75454'),
    'brace': format('darkGray'),
    'defclass': format('lightGray', 'bold'),
    'string': format('#fbff80'),  # yellow
    'string2': format('#a8cc66'),  # between string and comment
    'comment': format('#6fb06b', 'italic'),  # light green
    'self': format('orange', 'italic'),
    'numbers': format('#b3f0ff'),  # low saturation light blue
}
